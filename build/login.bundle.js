...
class Login extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  ...
  render() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'p',
        { className: this.props.propsValue },
        this.props.propsValue
      ),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'p',
        { className: this.state.stateValue },
        this.state.stateValue
      ),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'button',
        { onClick: () => this.setState({ stateValue: "R" }) },
        'Click me'
      )
    );
  }
};
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Login, { propsValue: 10 }), document.getElementById('login'));
